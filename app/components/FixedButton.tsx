...
export default function FixedButton() {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const tl = gsap
        ...
        .from(buttonRef.current, { x: 150, opacity: 0, ease: "power2.out", duration: 0.6 });
  ...
  return (
    ...
    >
      <div
        className="relative rotate-90 top-[55svh] right-5 origin-right py-2 px-6 h-max bg-black text-white flex items-center gap-2 text-xl pointer-events-auto cursor-pointer"
        ref={buttonRef}
